...
namespace UtilityTools.Modules.ButterflyValveTest.ViewModels
{
   
    public class ButterflyValveTestViewModel : RegionViewModelBase
    {
        #region ------------Constructor------------
        public ButterflyValveTestViewModel(IContainerProvider containerProvider, IDialogHostService dialogHostService)
        ...
        private ButterflyValveTestModel _model;

        public ButterflyValveTestModel Model
        {
            get { return _model; }
        ...
        {
            Model = containerProvider.Resolve<ButterflyValveTestModel>();
        }
